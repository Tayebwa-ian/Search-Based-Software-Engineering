...
public class AlgorithmBuilder {
    ...
    public static SearchAlgorithm<TestOrder> build(
        ...
        if (algorithm == SearchAlgorithmType.RANDOM_SEARCH) {
            return buildRandomSearch(stoppingCondition, coverageMatrix, random);
        } else if (algorithm == SearchAlgorithmType.RANDOM_WALK) {
            return buildRandomWalk(stoppingCondition, coverageMatrix, random);
        } else if (algorithm == SearchAlgorithmType.SIMULATED_ANNEALING) {
            return buildSimulatedAnnealing(stoppingCondition, coverageMatrix, random);
        } else if (algorithm == SearchAlgorithmType.SIMPLE_GENETIC_ALGORITHM) {
            return buildSimpleGeneticAlgorithm(stoppingCondition, coverageMatrix, random);
        } else {
            // Handle unexpected algorithm values
